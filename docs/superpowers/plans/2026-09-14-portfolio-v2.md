...
- Кожен текст, який бачить користувач, має тип `Localized` з непорожніми `uk` і `en`.
...
Замінити тимчасові `uk`, які дублюють `en`, реальними українськими текстами: 24 `summary` + 112 `caption`.
