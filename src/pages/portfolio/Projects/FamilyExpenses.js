...
export default function FamilyExpenses(){
  ...
  const projest = {
    ...
    'photo':[
    {
      ...
      title: `A bot that makes it convenient to keep track of family expenses. The bot sends expense statistics charts. It also generates an HTML page with a complete list of expenses
