...
export default function BotPortfolio(){
    ...
    return(
      ...
      <Container className="About-header">
        ...
        <Row className="mb-5 mt-3 pt-md-3 align-items-center">
          ...
          <Col lg="1">
          <a href="https://zelse.asuscomm.com/portfolio/" target="_blank" rel="noopener noreferrer">
  ...
  const projest = {
    ...
    'photo':[
    {
      ...
      title: `HTML/CSS portfolio for chat bot development`,
    },
    {
        img: 'https://zelse.asuscomm.com/PortfolioStatic/OldPortfolio/2.png',
        title: ``,
      },
