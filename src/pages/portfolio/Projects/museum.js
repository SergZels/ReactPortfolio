...
export default function Museum(){
    ...
    return(
      ...
      <Container className="About-header">
        ...
        <Row className="mb-5 mt-3 pt-md-3 align-items-center">
         ...
         <Col lg="1">
          <a href="https://github.com/SergZels/Museum" target="_blank" rel="noopener noreferrer">
              <FaGithub size={40} />
            </a>
          </Col>
          <Col lg="1">
  ...
  const projest = {
    ...
    },
    {
      ...
      {
        img: 'https://zelse.asuscomm.com/PortfolioStatic/Museum/6.png',
        title: ``,
      },
      {
        img: 'https://zelse.asuscomm.com/PortfolioStatic/Museum/7.png',
        title: ``,
      },
      {
        img: 'https://zelse.asuscomm.com/PortfolioStatic/Museum/1.png',
        title: ``,
      },
